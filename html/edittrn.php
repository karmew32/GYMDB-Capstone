...
{
	$sql_update= "UPDATE trainer SET emp_fname='$_POST[fname_tb]', emp_lname='$_POST[lname_tb]', emp_section='$_POST[section_dd]', hourlyTrainingRate='$_POST[hrate_tb]' WHERE emp_ID='$empid'";
...
$sql = "SELECT * FROM trainer WHERE emp_ID='$empid'";
	...
	echo '<tr>
		...
		<td><input type="text" name="lname_tb" value="'.$row['emp_lname'].'"/></td>
                <td><select name="section_dd">
                        <option selected hidden value="'.$row['emp_section'].'">'.$row['emp_section'].'</option>
			...
			<option value="Swimming Pool">Swimming Pool</option>
                ...
                <td><input type="text" name="hrate_tb" value="'.$row['hourlyTrainingRate'].'"/></td>
	      <tr>';
}
 echo "</table>";
...
<br/> <br/><a href="trainer.php">Back</a><br/>
</form>
