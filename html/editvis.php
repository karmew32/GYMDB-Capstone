...
{
	$sql_update= "UPDATE visitor SET vis_fname='$_POST[fname_tb]', vis_lname='$_POST[lname_tb]', trn_ID='$_POST[trnid_dd]' WHERE ULID='$ulid'";
...
<br/> <br/><a href="visitor.php">Back</a><br/>
</form>
