...
{
	$sql_update= "UPDATE deskworker SET emp_fname='$_POST[fname_tb]', emp_lname='$_POST[lname_tb]', emp_section='$_POST[section_dd]', hourlyRate='$_POST[hrate_tb]' WHERE emp_ID='$empid'";
...
$sql = "SELECT * FROM deskworker WHERE emp_ID='$empid'";
	...
	echo '<tr>
		...
		<td><input type="text" name="lname_tb" value="'.$row['emp_lname'].'"/></td>
			...
			<option value="Swimming Pool">Swimming Pool</option>
                ...
                <td><input type="text" name="hrate_tb" value="'.$row['hourlyRate'].'"/></td>
	      <tr>';
}
 echo "</table>";
...
<br/> <br/><a href="deskworker.php">Back</a><br/>
</form>
